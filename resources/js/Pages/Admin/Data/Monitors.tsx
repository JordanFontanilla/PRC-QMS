...
interface DataTableProps<TData, TValue> {
    ...
    tableTitle?: string; // Add this line for dynamic title
    countText?: string; // Optional: Custom text for count display
}
...
export function DataTable<TData, TValue>({
    ...
    return (
        ...
        >
            ...
            <div className="sticky bottom-0 bg-white dark:bg-gray-950 border-t py-4 px-2">
