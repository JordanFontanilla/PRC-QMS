...
import { columns } from "./Columns/Processes";
import { DataTable } from "./Data/Processes";
...
export default function CounterPage({
    ...
    const { props } = usePage();
    const [data, setData] = useState<Processes[]>(processes ?? []);
    ...
    const [editFormData, setEditFormData] = useState<Processes | null>(null);
    ...
    const handleCreateSubmit = (e: React.FormEvent) => {
        ...
        router.post("/admin/processes/store", formData, {
            ...
            onSuccess: (page) => {
                ...
                setData(page.props.processes as Processes[]);
    ...
    const handleEdit = (process: Processes) => {
        setEditFormData(process);
        setFormData({
            process_name: process.process_name,
            department: process.department_id,
        });
